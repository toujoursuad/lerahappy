...
const messages = [
    "Клікни де завгодно",  
    "<img src='./images/bim.jpg' alt='Image 1' width='400' height='auto'>",  // Вставка зображення через HTML
    "Ще раз ❤️",  
    "<img src='./images/bimlera1.jpg' alt='Image 2' width='400' height='auto'>", 
    "А нічо шо",  
    "Лера ти шо",  
    "<img src='./images/lera.jpg' alt='Image 3' width='400' height='auto'>", 
    "Клікни ще раз",  
    "Давай, давай не здавайся",  
    "Обіцяю, останній раз",  
    "<img src='./images/snapchat.jpg' alt='Image 2' width='400' height='auto'>", 
    "Хаха",  
    "Шутканула",  
    "Останній",  
    "<img src='./images/family3.jpg' alt='Image 2' width='400' height='auto'>", 
    ...
    "Це сім'я", 
    "<img src='./images/family1.jpg' alt='Image 2' width='400' height='auto'>",
    "Ахахаха", 
    "Як би вони не бісили", 
    "<img src='./images/sudia.jpg' alt='Image 2' width='400' height='auto'>",
    "Ми завжди готові підтримати", 
    "І рознести по фактам", 
    "Ахахахах",  
    "<img src='./images/family7.jpg' alt='Image 2' width='400' height='auto'>",
    "Ми нагадуємо",  
    "Шоб ти не забувала", 
    "<img src='./images/family8.jpg' alt='Image 2' width='400' height='auto'>",
    "ахахах", 
    "Що",  
    "Валерія",  
    "Ми тебе дуже любимо ❤️",  
    "<img src='./images/family4.jpg' alt='Image 2' width='400' height='auto'>",
    "І дуже тобою пишаємось",  
    "<img src='./images/sura2.jpg' alt='Image 2' width='400' height='auto'>",
    "З Днем Народження",  
